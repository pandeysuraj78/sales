...
function FullPageLoader() {
    return (<div className="fixed inset-0 bg-white bg-opacity-75 backdrop-blur-sm flex items-center justify-center z-50">
...
function ButtonSpinner({ className = '' }) {
    return (<LoadingSpinner size="sm" color="white" className={`mr-2 ${className}`}/>);
}
